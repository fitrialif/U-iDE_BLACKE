...
\begin{center}
{\color{DarkRed2}{\Huge\bf BLACK: Body Language Affect Classification Kernel}}\\
{\color{DarkBlue}{\LARGE Undergrad-ient Descent Expedition}}\\
{\color{DarkBlue}{\large Jack (Xiang) Zhou, James Bie, Karan Aujla, Eric Gao, Insoo Rhee}}\\
\end{center}
\end{minipage} &
\end{tabularx}
